  ...
  return (
    <Container paddingX={2}>
      {settlementDetails.length > 0 ? (
        ...
        <BoxOutline paddingY={4}>
          <Heading size={'h1'} marginBottom={2}>All done!</Heading>
          <Heading size={'h5'} marginBottom={8}>No debts to settle.</Heading>
          <Button width={'100%'} colorScheme='green' bg='green.400' onClick={() => router.back()}>Return</Button>
        </BoxOutline>
      )}
    </Container>
  )
