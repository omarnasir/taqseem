...
const customTheme = extendTheme({ config, fonts },
	{
		colors: {
			...
			// bg: '#101317',
			// bg: '#000000',
			bg: 'linear-gradient(0deg, #080810 0%, #1A1C20 90%, #1A1C24 100%)',
			bgHeader: 'linear-gradient(0deg, #1A1C20 0%, #1A1C24 100%)',
			// itemSurface: 'linear-gradient(45deg, #383A3F 0%, #28262A 100%)',
			itemSurface: 'linear-gradient(215deg, #1F2228 0%, #24283A 100%)',
			// bg: 'rgba(25,25,25, 1)',
			...
			bgModal: 'linear-gradient(135deg, rgba(25,25,25, 0.15) 0%, rgba(55,55,55, 0.20) 100%)',
			// bgListItem: '#111114',
